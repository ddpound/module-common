package com.example.modulecommon.makefile;
...
//    유저아이디-(종류썸네일,제품)-UUID
     ...
     * @param userId 파일이름에 id가 들어감 누구소유인지,
     ...
     *  3. 데베에 저장할 파일 이름
     * */
    public Map<Integer,String> makeFileImage(int userId,
        ...
        String savedFileName = userId+"-"+ UUID.randomUUID()+extension;
    ...
    public JsonObject makeTemporaryfiles(MultipartFile multipartFile,
        ...
        try {
            ...
            String temporarySavePath = AllStaticStatus.temporaryImageFiles+File.separator+userId+File.separator;
            ...
            String saveFileName = userId +"-"+ UUID.randomUUID() + extension;
